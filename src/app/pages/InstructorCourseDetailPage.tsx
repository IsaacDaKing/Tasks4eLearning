...
const roster = [
  { name: "Maya Chen", email: "maya.chen@utd.edu", section: "Team Alpha" },
  { name: "Jordan Patel", email: "jordan.patel@utd.edu", section: "Team Alpha" },
...
export function InstructorCourseDetailPage() {
  ...
  const cloneCourse = () => {
    if (selectedCourse) {
      alert(`Cloning "${selectedCourse.name}" with ${selectedCourse.modules} modules.`);
  ...
  return (
    <div className="min-h-full bg-slate-100 p-4 text-slate-900 dark:bg-slate-950 dark:text-slate-100 sm:p-6 lg:p-8">
      <div className="mx-auto max-w-6xl space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="rounded border border-slate-200 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-800">
                    <p className="text-xs font-black uppercase tracking-wide text-slate-500">Anonymous post 1</p>
                    <p className="mt-1 text-sm leading-5 text-slate-700 dark:text-slate-200">I understand the requirements, but some of the technical constraints are unclear.</p>
                  </div>
                  <div className="rounded border border-slate-200 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-800">
                    <p className="text-xs font-black uppercase tracking-wide text-slate-500">Anonymous post 2</p>
                    <p className="mt-1 text-sm leading-5 text-slate-700 dark:text-slate-200">The examples really helped me understand the concept better.</p>
                  </div>
                </div>
              </div>
            )}
        ...
        <div className="grid gap-6 xl:grid-cols-2">
          {/* File Uploader */}
          <FeatureCard icon={Upload} title="Drag-and-Drop File Uploader" eyebrow="Module materials">
            <div className="space-y-4">
              <div
              ...
              {selectedCourse && (
                <div className="rounded border border-blue-200 bg-blue-50 p-4 dark:border-blue-900/60 dark:bg-blue-950/30">
                  <p className="text-sm text-blue-900 dark:text-blue-200">
                    <span className="font-bold">{selectedCourse.modules}</span> modules will be cloned
                  </p>
                </div>
              )}
              <button 
          ...
          <FeatureCard icon={Users} title="Peer Review Assignments" eyebrow="Random allocation">
            <div className="overflow-hidden rounded border border-slate-200 dark:border-slate-700">
              <table className="w-full text-sm">
                <thead className="bg-slate-50 dark:bg-slate-800">
                  <tr>
                    <th className="px-3 py-2 text-left font-bold">Reviewer</th>
                    <th className="px-3 py-2 text-left font-bold">Reviewee</th>
                    <th className="px-3 py-2 text-left font-bold">Status</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
